...
export default React.createClass({
  ...
  render: function () {
    ...
    return (
      <div>
        <a className='github-link' href='https://github.com/kevinlitchfield/base64-visualizer'>
          <svg className='github-logo' viewBox="0 0 128 128">
        ...
        <p>See how a UTF-8 string is encoded to Base64 (as specified in <a href='https://tools.ietf.org/html/rfc1421'>RFC 1421</a>).</p>

        <p>Enter a string (special characters like ü, 好, and 😉 are OK):</p>
        
        <input className='input-text' type='text' value={input.string} placeholder='Enter a UTF-8 string' onChange={this.handleInputChange} />
